...
function CopyBtn({ text }: { text: string }) {
  ...
  return (
    <button
      ...
      className="p-1 rounded hover:bg-[var(--bg-1)]/[0.02] transition-colors"
    >
  ...
  return (
    <div className="border border-white/[0.04] rounded-lg overflow-hidden">
      <button
        ...
        className="w-full flex items-center gap-3 px-4 py-3 hover:bg-[var(--bg-1)]/[0.02] transition-colors"
      >
                ...
                <div>
                  ...
                  <div className="space-y-1.5 mb-4">
                    {Object.entries(schema).map(([field, type]) => (
                      <div key={field} className="flex items-center gap-3 text-sm py-1.5 px-3 bg-[var(--bg-1)]/[0.02] rounded">
      ...
      <div className="glass p-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-xs">
          {[
            ...
            <div key={code} className="flex items-center gap-2 py-1.5 px-3 rounded bg-[var(--bg-1)]/[0.02]">
