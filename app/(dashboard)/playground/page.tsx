...
function CopyBtn({ text }: { text: string }) {
  ...
  return (
    <button
      ...
      className="p-1.5 rounded hover:bg-[var(--bg-2)] transition-colors"
    >
...
export default function PlaygroundPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Request Builder */}
      <div className="sf-elevated overflow-hidden">
        {/* Method + URL bar */}
        <div className="flex items-center gap-3 p-4 border-b border-white/[0.06]">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-[var(--bg-2)] border border-white/[0.06] text-[var(--text-2)]
          ...
          {/* Full URL display */}
          <div className="flex-1 flex items-center gap-2 bg-[var(--bg-2)] rounded-lg px-3 py-2.5 border border-white/[0.06]">
        ...
        <AnimatePresence>
          {['POST', 'PUT'].includes(method) && (
            ...
            >
              <div className="flex items-center justify-between px-4 py-2 bg-[var(--bg-2)]">
      ...
      <AnimatePresence>
        {response && (
          ...
          >
            {/* Response header */}
            <div className="flex items-center justify-between px-5 py-3 border-b border-white/[0.06] bg-[var(--bg-2)]">
      ...
      {/* Code Snippets */}
      <div className="sf overflow-hidden">
        <button
        ...
        <AnimatePresence>
          {showSnippets && (
            ...
            >
              {/* Language tabs */}
              <div className="flex items-center gap-1 px-4 py-2 bg-[var(--bg-2)] border-b border-white/[0.06]">
